    ...
    <div class="user_auth_section">
      <div class="nclex_title">
        <div class="header_img">
          <!-- unc logo functions as home button -->  
          <img
  ...
  methods: {
        ...
        try {
          ...
          if (
            ...
            switch (this.$store.state.user.userType) {
              ...
              default:
                this.createErrorMessage(
                  "User type not valid. Please contact your instructor.",
                  10000
                );
                break;
            }
          ...
          this.createErrorMessage(
            "There was a problem logging in. Please contact your instructor.",
            10000
          );
          console.log(error);
        }
    ...
    async handlePasswordRecovery() {
      ...
      if (error == null) {
        ...
        this.createErrorMessage(
          "Too many requests. Please wait 60s before making another request.",
          10000
        );
        console.log(error);
        console.log(data);
    ...
    isValidPassword() {
      ...
      if (
        !validPasswordPattern.test(this.password.password) ||
